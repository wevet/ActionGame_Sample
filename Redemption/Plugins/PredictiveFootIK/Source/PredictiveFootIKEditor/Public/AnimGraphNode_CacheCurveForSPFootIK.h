...
#include "AnimGraphNode_CacheCurveForSPFootIK.generated.h"

class FMenuBuilder;

/** Easy way to cache curve values for sp foot ik */
UCLASS()
class PREDICTIVEFOOTIKEDITOR_API UAnimGraphNode_CacheCurveForSPFootIK : public UAnimGraphNode_Base
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, Category=Settings)
	FAnimNode_CacheCurveForSPFootIK Node;

public:
	UAnimGraphNode_CacheCurveForSPFootIK();
