...
#include "AnimNode_CacheCurveForPredictiveIK.generated.h"

USTRUCT(BlueprintInternalUseOnly)
struct REDEMPTION_API FAnimNode_CacheCurveForPredictiveIK : public FAnimNode_Base
{
	GENERATED_BODY()
...
public:
	...
	EPredicIKGait Gait = EPredicIKGait::Walk;

	UPROPERTY()
	TArray<FName> CurveNames;

private:
	UPredictiveIKComponent* TargetComp = nullptr;
	float FinalWeight = 0.f;

public:
	FAnimNode_CacheCurveForPredictiveIK();
